            ...
            <div className="slick-multiItemSlider">
              <div className="movie-item">
                ...
                <div className="title-in">
                  ...
                  <h6>
                    <a href="/SingleMovie">Interstellar</a>
                  </h6>
                  <p>
              ...
              <div className="movie-item">
                ...
                <div className="title-in">
                  ...
                  <h6>
                    <a href="/SingleMovie">The revenant</a>
                  </h6>
                  <p>
                    <i className="ion-android-star"></i>
                    <span>7.4</span> /10
            ...
            <div className="col-md-8">
              ...
              <div className="tabs">
                <ul className="tab-links">
                  ...
                  <li>
                    <a href="/comminsoon"> #Coming soon</a>
                  </li>
                  <li>
              ...
              <div className="tabs">
                <ul className="tab-links-2">
                  ...
                  <li className="active">
                    <a href="/commingsong"> #Coming soon</a>
                  </li>
                  <li>
                ...
                <div className="celebrities">
                  ...
                  <div className="celeb-item">
                    ...
                    <div className="celeb-author">
                      <h6>
                        <a href="/celebrities">Samuel N. Jack</a>
                      </h6>
                      <span>Actor</span>
                    </div>
                  </div>
                  <div className="celeb-item">
                    ...
                    <div className="celeb-author">
                      <h6>
                        <a href="/celebrities">Benjamin Carroll</a>
                      </h6>
                      <span>Actor</span>
                    </div>
                  </div>
                  <div className="celeb-item">
                    ...
                    <div className="celeb-author">
                      <h6>
                        <a href="/celebrities">Beverly Griffin</a>
                      </h6>
                      <span>Actor</span>
                    </div>
                  </div>
                  <div className="celeb-item">
                    ...
                    <div className="celeb-author">
                      <h6>
                        <a href="/celebrities">Justin Weaver</a>
                      </h6>
                      <span>Actor</span>
                    </div>
                  </div>
                  <a href="/celebrities" className="btn">
            ...
            <div className="col-md-8">
              ...
              <div className="morenew">
                <div className="title-hd">
                  ...
                  <a href="#" className="viewall">
                    See all Movies news<i className="ion-ios-arrow-right"></i>
                  </a>
                </div>
                <div className="more-items">
                  ...
                  <div className="right">
                    <div className="more-it">
                      <h6>
                        <a href="#">
                          Laura Dern in talks to join Justin Kellys biopic “JT
                          Leroy”
                        </a>
                      </h6>
                      <span className="time">13 hours ago</span>
