					...
					<ul className="nav navbar-nav flex-child-menu menu-left">
						...
						<li className="dropdown first">
							...
							<ul className="dropdown-menu level1">
								<li><a href="/UserFavoriteMovie">user favorite movie</a></li>
								<li><a href="/perfilUsuario">user profile</a></li>
							</ul>
						</li>
					</ul>
	...
	<div className="container">
		<div className="flex-parent-ft">
			...
			<div className="flex-child-ft item5">
				<h4>Newsletter</h4>
				<p>Subscribe to our newsletter system now <br></br> to get latest news from us.</p>
				<form action="#">
